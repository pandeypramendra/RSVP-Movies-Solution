...
-- below is code to show count of null values in each column of Table movie 
...
-- below is code for movie released in each year 
-- Solution 3 
...
+---------------+-------------------+---------------------+----------------------+-----------------+-----------------+*/
-- Type your code below:
-- below is desired code for requested output ..
SELECT
...
INNER JOIN movie AS m
ON m.id = g.movie_id
WHERE country='USA' AND total_votes>1000 AND date_published between '2017-03-01' and '2017-03-31'
GROUP BY genre
ORDER BY movie_count DESC;
...
top3_genre
WHERE g.genre in (top3_genre.genre) AND avg_rating>8
